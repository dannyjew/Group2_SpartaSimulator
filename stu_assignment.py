def student_assignment(list_of_centers, waiting_list, intake_list):
    ...
    a number between 0 and 20 for each center. Waiting list is prioritised , and trainees not intaken are added to waiting list
    ...
    :param intake_list: integer of trainee intake that month, should not be 0
